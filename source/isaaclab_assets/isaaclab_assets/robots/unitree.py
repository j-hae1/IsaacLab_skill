...
from isaaclab.actuators import ActuatorNetMLPCfg, DCMotorCfg, ImplicitActuatorCfg, DelayedImplicitActuatorCfg
...
G1_29_FIXED_HAND_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/hae1/workspace/IsaacLab_skill/unitree_models/g1_hand.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
G1_LIDAR_CFG.spawn.usd_path = "/home/hae1/workspace/IsaacLab_skill/unitree_models/g1_29dof_rev_1_0_lidar.usd"
